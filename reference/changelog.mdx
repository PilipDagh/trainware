---
title: Changelog
description: Weekly release notes covering new features, updates, and bug fixes.
---

A summary of changes by release week. The full source-of-truth log is maintained in [`CHANGELOG.md`](https://github.com/PilipDagh/trainware/blob/main/CHANGELOG.md).

## Week of May 18, 2026

### New features

- **Live multiplayer gameplay.** Movement, aiming, shooting, reloading, mining, bomb throwing, and knife stabs now sync between everyone in the lobby in real time. See [Lobbies and multiplayer](/multiplayer/lobbies).
- **Beer barrels you can place and share.** Drop a Beer Barrel anywhere on the train, then have anyone in your group walk up and drink from it. Bottles can top barrels back up so a crew can keep one barrel going for a whole run. See [Beer and drunk perks](/gameplay/beer-and-drunk-perks).
- **Drunk perks (and consequences).** Three or more sips give you an 11% movement and 20% damage boost with pistol and knife. Push past 11 sips and your character explodes, so pace yourself.
- **Coal-to-fuel cart.** Walk up to the coal car with mined coal in your inventory and dump it in to refuel the train (50 fuel per coal). Anyone in the group can contribute. See [Train and fuel](/gameplay/train-and-fuel).
- **Sell ores at the shop.** Approaching the shop NPC now auto-sells any gold and silver in your inventory ($5 and $3 each) before opening the menu. See [Shop and economy](/gameplay/shop-and-economy).
- **Spectate teammates after dying.** Cycle through living players and watch the run continue instead of staring at a static screen. See [Spectator mode and restart voting](/multiplayer/spectator-and-restart).
...
- **Manual reload.** Reload now pulls from your reserve ammo on demand and tops the magazine without wasting bullets, replacing the older auto-reload behavior. See [Combat and reload](/gameplay/combat-and-reload).
- **Horse riding.** Walk up to a riderless horse and interact to mount it for a movement speed boost out in the wilderness. See [Horse riding](/gameplay/horse-riding).
